...
<template>
  <div class="multi-props-shell">
    <n-scrollbar class="multi-props-shell__scroll">
      <div class="multi-props-shell__content">
        <div class="multi-props">
          <n-text depth="3" class="multi-props__count">已选中 {{ selectedCount }} 个图元</n-text>
        </div>
        <n-collapse class="multi-props__collapse" :default-expanded-names="['appearance', 'text', 'effect', '0']">
          <n-collapse-item title="批量外观" name="appearance">
            <n-form class="multi-props__form" label-placement="left" label-width="92px" label-align="left">
...
.multi-props-shell__scroll {
  height: 100%;
}

.multi-props-shell__content {
  padding: 0 10px 10px;
}
...
::v-deep(.multi-props__collapse .n-collapse-item) {
  border-bottom: 1px solid #eef2f7;
}

::v-deep(.multi-props__collapse .n-collapse-item__header) {
  min-height: 42px;
  font-size: 14px;
  font-weight: 600;
  color: #1f2937;
...
::v-deep(.multi-props__collapse .n-collapse-item__content-inner) {
  padding-top: 2px;
  padding-bottom: 10px;
}

::v-deep(.multi-props__form .n-form-item) {
  padding: 10px 0;
  margin-bottom: 0;
  border-bottom: 1px solid #eef2f7;
}

::v-deep(.multi-props__form .n-form-item:last-child) {
  border-bottom: 0;
}

::v-deep(.multi-props__form .n-form-item-label) {
  font-weight: 500;
  color: #334155;
}
</style>
